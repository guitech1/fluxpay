...
router.get("/organizations", async (req, res, next) => {
  try {
    ...
    const selectCols =
      "id, name, slug, legal_name, document, email, country, status, status_reason, status_changed_at, created_at, kyc_required, kyc_status, kyc_verified_at, kyc_document_masked, kyc_rejection_reason";
