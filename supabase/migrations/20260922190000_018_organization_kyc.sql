-- Organization-scoped optional KYC.
-- Production schema was checked before implementation and the requested KYC
-- columns/table were not present, so this migration makes the connected schema
-- reproducible.
